...
exports.GUIDE_ON_POINTER_EVENT = "on-pointer-events";
...
function clear() {
    ...
    t.forEach((e) => {
        ...
        e.className = e.className.replace(exports.GUIDE_ON_POINTER_EVENT, "");
    });
